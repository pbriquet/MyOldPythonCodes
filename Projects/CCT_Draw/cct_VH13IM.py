...
if __name__=='__main__':
    ...
    transormation_data = [
        ...
        dict(type='Ms',T0=T0,rate=1.0,T=358.0),
        dict(type='Mf',T0=T0,rate=1.0,T=170.0),

        dict(type='Ms',T0=T0,rate=0.5,T=358.0),
        dict(type='Mf',T0=T0,rate=0.5,T=170.0),
        dict(type='Bs',T0=T0,rate=0.5,T=358.0),
        #dict(type='Bf',T0=T0,rate=0.5,T=320.0),

        #dict(type='Ms',T0=T0,rate=0.2,T=358.0),
        #dict(type='Mf',T0=T0,rate=0.2,T=170.0),
        dict(type='Bs',T0=T0,rate=0.2,T=400.0),
        dict(type='Bf',T0=T0,rate=0.2,T=305.0),

        dict(type='Bs',T0=T0,rate=0.1,T=420.0),
        dict(type='Bf',T0=T0,rate=0.1,T=310.0),
        dict(type='Ps',T0=T0,rate=0.1,T=728.0),


        dict(type='Bs',T0=T0,rate=0.05,T=440.0),
        dict(type='Bf',T0=T0,rate=0.05,T=339.0),
        dict(type='Ps',T0=T0,rate=0.05,T=792.0),
        dict(type='Pf',T0=T0,rate=0.05,T=714.0),
