...
class TTT:
    ...
    def __init__(self,T0,Ac1,Ac3,transformation_data, data_file):
    ...
    def plot_TTT(self,color_schema,font_schema,ticks_schema,grid_schema,**kwargs):
        name = 'ttt_TENAX300IM'
...
if __name__=='__main__':
    ...
    mainfolder = os.path.realpath(os.path.join(os.getcwd(),os.path.dirname(__file__)))
    filepath = os.path.join(mainfolder,'ttt_TENAX300IM_dados.xlsx')

    

    ttt = TTT(T0,Ac1,Ac3,transormation_data,filepath)
    ttt.plot_TTT(colors,font_kwargs,ticks_kwargs,grid_kwargs,show=True)