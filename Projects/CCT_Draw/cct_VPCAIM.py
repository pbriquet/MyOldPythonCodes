...
class CCT:
    ...
    def plot_CCT(self,color_schema,font_schema,ticks_schema,grid_schema,**kwargs):
        ...
        plot_limits = {'X':[1e1,10.0**5],'Y':[25.0,1100.0]}
        ...
        for transf in transformations:
            if transf in self.treated_data.keys():
                ...
                if(transf == 'Ms'):
                    ...
                    #ax.plot([self.treated_data['Mf']['X'][-1],self.treated_data['Ms']['X'][-1]],[self.treated_data['Mf']['Y'][-1],self.treated_data['Ms']['Y'][-1]],color=schema[transf]['color'],zorder=10,lw=2.0,linestyle=':')
        ...
        #ax.set_title('VPCAIM',**font_schema)
...
if __name__=='__main__':
    ...
    transormation_data = [
        dict(type='Ms',T0=T0,rate=50.0,T=357.1),
        dict(type='Ms',T0=T0,rate=4.0,T=355.3),
        dict(type='Ms',T0=T0,rate=0.5,T=367.6),
        dict(type='Ms',T0=T0,rate=0.085,T=395.5836),

        dict(type='Mf',T0=T0,rate=50.0,T=101.6),
        dict(type='Mf',T0=T0,rate=4.0,T=101.6),
        dict(type='Mf',T0=T0,rate=0.085,T=101.6),

        dict(type='Bs',T0=T0,rate=0.085,T=395.5836),
        #dict(type='Bs',T0=T0,rate=0.04,T=437.5601),
        dict(type='Bs',T0=T0,rate=0.03,T=469.0424),
        dict(type='Bs',T0=T0,rate=0.008,T=539.0031),
        

        #dict(type='Bf',T0=T0,rate=0.085,T=395.5836),
        dict(type='Bf',T0=T0,rate=0.04,T=330.87),
        dict(type='Bf',T0=T0,rate=0.03,T=304.6349)
    ]
    '''
        dict(type='Bf',T0=T0,rate=0.08553012805513634,T=383.3406),
        dict(type='Bf',T0=T0,rate=0.042913116562800876,T=388.5877),
        dict(type='Bf',T0=T0,rate=0.026545108220598735,T=386.8387),
        dict(type='Bf',T0=T0,rate=0.00907556093027496,T=392.0857),
    '''
