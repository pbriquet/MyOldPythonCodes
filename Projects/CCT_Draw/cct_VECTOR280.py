...
class CCT:
    ...
    def plot_CCT(self,color_schema,font_schema,ticks_schema,grid_schema,**kwargs):
        ...
        language_data = dict(
            ...
            Portuguese={'Xlabel':'t (s)','Ylabel':'T ' + r'$\mathrm{(°C)}$','Y2label':'T ' + r'$\mathrm{(°F)}$'}
        )
        plot_limits = {'X':[1e0,10.0**5],'Y':[100.0,1000.0]}
        ...
        ac3 = plt.hlines(self.Ac3,plot_limits['X'][0],plot_limits['X'][-1],schema['Ac3']['color'],label=r'$Ac_3$',zorder=10,lw=1.5)
        ac1 = plt.hlines(self.Ac1,plot_limits['X'][0],plot_limits['X'][-1],schema['Ac1']['color'],label=r'$Ac_1$',zorder=10,lw=1.5)
...
if __name__=='__main__':
    ...
    second_version_grid = dict(
        ...
        minor=dict(b=False,lw=0.7,ls='-',color='gray',alpha=0.7),
    ...
    transormation_data = [
        dict(type='Ms',T0=T0,rate=50.0,T=401.3),
        dict(type='Mf',T0=T0,rate=50.0,T=211.2),
        dict(type='Ms',T0=T0,rate=1.0,T=400.0),
        dict(type='Mf',T0=T0,rate=1.0,T=210.0),
        dict(type='Ms',T0=T0,rate=0.5,T=400.0),
        dict(type='Mf',T0=T0,rate=0.5,T=210.0),
        dict(type='Bs',T0=T0,rate=1.0,T=480.0),
        dict(type='Bs',T0=T0,rate=0.5,T=510.0),
        dict(type='Bs',T0=T0,rate=0.05,T=490.0),
        dict(type='Bs',T0=T0,rate=0.02,T=495.0),
        dict(type='Bs',T0=T0,rate=0.01,T=480.0),
        dict(type='Bf',T0=T0,rate=0.5,T=400.0),
        dict(type='Bf',T0=T0,rate=0.05,T=300.0),
        dict(type='Bf',T0=T0,rate=0.02,T=290.0),
        dict(type='Bf',T0=T0,rate=0.01,T=285.0),
