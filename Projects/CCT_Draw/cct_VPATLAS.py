...
class CCT:
    ...
    def plot_CCT(self,color_schema,font_schema,ticks_schema,grid_schema,**kwargs):
        ...
        plot_limits = {'X':[1e1,1e5],'Y':[100.0,950.0]}
        ...
        #ax.set_title('VPATLASIM',**font_schema)
...
if __name__=='__main__':
    ...
    Ac3 = 835.7
    transormation_data = [
        dict(type='Ms',T0=T0,rate=50.0,T=361.0),
        #dict(type='Ms',T0=T0,rate=2.0,T=342.0),
        #dict(type='Ms',T0=T0,rate=0.5,T=344.0),
        #dict(type='Ms',T0=T0,rate=0.3,T=338.0),
        dict(type='Ms',T0=T0,rate=0.3,T=361.0),
        dict(type='Bf',T0=T0,rate=0.3,T=361.0),
        dict(type='Bf',T0=T0,rate=0.05,T=285.0),

        dict(type='Mf',T0=T0,rate=50.0,T=158.0),
        dict(type='Mf',T0=T0,rate=0.3,T=158.0),
        #dict(type='Mf',T0=T0,rate=2.0,T=139.0),
        #dict(type='Mf',T0=T0,rate=0.5,T=153.0),
        #dict(type='Mf',T0=T0,rate=0.3,T=151.0),
        #dict(type='Mf',T0=T0,rate=0.1,T=180.0),
        #dict(type='Mf',T0=T0,rate=0.05,T=194.0),

        dict(type='Bs',T0=T0,rate=0.3,T=361.0),
        dict(type='Bs',T0=T0,rate=0.1,T=413.0),
        dict(type='Bs',T0=T0,rate=0.05,T=414.0),
        dict(type='Bs',T0=T0,rate=0.03,T=408.0),
        dict(type='Bs',T0=T0,rate=0.02,T=429.0),
        dict(type='Bs',T0=T0,rate=0.01,T=429.0),

        dict(type='Bf',T0=T0,rate=0.05,T=285.0),
        dict(type='Bf',T0=T0,rate=0.03,T=278.0),
        dict(type='Bf',T0=T0,rate=0.02,T=272.0),
