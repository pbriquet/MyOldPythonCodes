...
if __name__=='__main__':
    ...
    '''
    transormation_data = [
        dict(type='Ms',T0=T0,rate=50.0,T=329.0),
        dict(type='Mf',T0=T0,rate=50.0,T=120.0),

        dict(type='Ms',T0=T0,rate=2.0,T=340.0),
        dict(type='Mf',T0=T0,rate=2.0,T=70.6),

        dict(type='Ms',T0=T0,rate=1.0,T=336.1),
        dict(type='Mf',T0=T0,rate=1.0,T=120.0),

        dict(type='Ms',T0=T0,rate=0.5,T=336.4),
        dict(type='Mf',T0=T0,rate=0.5,T=172.2),
        dict(type='Bs',T0=T0,rate=0.5,T=329.0),
        #dict(type='Bf',T0=T0,rate=0.5,T=320.0),

        #dict(type='Ms',T0=T0,rate=0.2,T=268.0),
        dict(type='Mf',T0=T0,rate=0.2,T=101.0),
        dict(type='Bs',T0=T0,rate=0.2,T=362.4),
        #dict(type='Bf',T0=T0,rate=0.2,T=305.0),


        #dict(type='Ms',T0=T0,rate=0.1,T=274.0),
        dict(type='Mf',T0=T0,rate=0.1,T=147.2),
        dict(type='Bs',T0=T0,rate=0.1,T=394.4),
        dict(type='Bf',T0=T0,rate=0.1,T=274.0),
        #dict(type='Ps',T0=T0,rate=0.1,T=728.0),

        dict(type='Ps',T0=T0,rate=0.06,T=768.2),
        #dict(type='Pf',T0=T0,rate=0.06,T=765.2),

        dict(type='Bs',T0=T0,rate=0.05,T=404.0),
        dict(type='Bf',T0=T0,rate=0.05,T=246.7),
        dict(type='Ps',T0=T0,rate=0.05,T=790.0),
        dict(type='Pf',T0=T0,rate=0.05,T=730.0),
        

        dict(type='Ps',T0=T0,rate=0.03,T=827.7),
        dict(type='Pf',T0=T0,rate=0.03,T=704.7),
